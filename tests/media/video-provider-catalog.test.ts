...
const adapterMocks = vi.hoisted(() => {
  ...
  return {
    ...
    'wan3-video': { generate: vi.fn(), test: vi.fn(connectivity) },
  };
});
...
vi.mock('@/lib/media/adapters/wan3-video-adapter', () => ({
  generateWithWan3Video: adapterMocks['wan3-video'].generate,
  testWan3VideoConnectivity: adapterMocks['wan3-video'].test,
}));
