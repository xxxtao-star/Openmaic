...
| Prefix               | Provider                                                            |
| -------------------- | ------------------------------------------------------------------- |
| `OPENAI_`            | OpenAI-compatible channel (ships the built-in domestic catalogue)   |
| `AZURE_OPENAI_`      | Azure OpenAI                                                        |
| `ATLASCLOUD_`        | AtlasCloud                                                          |
| `DEEPSEEK_`          | DeepSeek                                                            |
| `QWEN_`              | Alibaba Qwen                                                        |
| `KIMI_`              | Moonshot Kimi                                                       |
...
The built-in `OPENAI_` prefix is a generic OpenAI-compatible channel: by default it
serves the domestic model catalogue (Qwen, DeepSeek, GLM, Kimi). Point
`OPENAI_BASE_URL` at a relay or gateway to serve that catalogue from there, or use
`OPENAI_MODELS` to narrow it.
